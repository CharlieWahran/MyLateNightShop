...
// session  start est le commencement dune nouvelle session en se connectant
session_start();
...
<div class="home_bg">
    ...
    <div class="content"> 
        <span>Du sucré ? Du salé ? Petite faim ? Grande faim?</span>
        <h3>Vos produits préférés disponible 24h/24 7j/7</h3>
        <p>En livraison ou à emporter</p>
        <a href="about.php" class="btn">Qui sommes nous ?</a>
    </div>
...
<section class="home_category">
    ...
    <div class="box_container">
        ...
        <div class="box">
            <img src="uploaded_picture/categories/gateaux_assort.jpeg" alt="">
            <h3>Gateaux</h3>
            <p></p>
            <a href="category.php?category=gateaux" class="btn">Voir</a>
        </div>


        <div class="box">
            <img src="uploaded_picture/categories/bonbon_assort.jpeg" alt="">
            <h3>Bonbons</h3>
            <p></p>
            <a href="category.php?category=bonbon" class="btn">Voir</a>
        </div>


        <div class="box">
            <img src="uploaded_picture/categories/apero_assort.jpeg" alt="">
            <h3>Appéritifs </h3>
            <p></p>
            <a href="category.php?category=aperitif" class="btn">Voir</a>
        </div>

        <div class="box">
            <img src="uploaded_picture/categories/boisson_assort.jpeg" alt="">
            <h3>Boissons</h3>
            <p></p>
            <a href="category.php?category=boisson" class="btn">Voir</a>
        </div>

        <div class="box">
            <img src="uploaded_picture/categories/alcools_assort.jpeg" alt="">
            <h3>Alcools</h3>
            <p></p>
            <a href="category.php?category=alcool" class="btn">Voir</a>
        </div>

        <div class="box">
            <img src="uploaded_picture/categories/autres.jpeg" alt="">
            <h3>Autres</h3>
            <p></p>
            <a href="category.php?category=autres" class="btn">Voir</a>
        </div>
